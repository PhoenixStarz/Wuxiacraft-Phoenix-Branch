...
public class OreGeneration {
	...
	public static Holder<PlacedFeature> DEEPSLATE_SPIRIT_GEN_2;
	...
	public static void registerOres() {
		...
		OreConfiguration spirit_vein_2 = new OreConfiguration(OreFeatures.STONE_ORE_REPLACEABLES, WuxiaBlocks.SPIRIT_STONE_VEIN_2.get().defaultBlockState(), 4);
		OreConfiguration deepslate_spirit_vein_2 = new OreConfiguration(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, WuxiaBlocks.DEEPSLATE_SPIRIT_STONE_VEIN_2.get().defaultBlockState(), 4);
		OreConfiguration spirit_vein_3 = new OreConfiguration(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, WuxiaBlocks.SPIRIT_STONE_VEIN_3.get().defaultBlockState(), 3);
		...
		SPIRIT_GEN_2 = registerPlacedOreFeature("overworld_spirit_vein_2",
				...
				InSquarePlacement.spread(),
				BiomeFilter.biome(),
				HeightRangePlacement.triangle(VerticalAnchor.absolute(-44),
						VerticalAnchor.absolute(10))
		);
		DEEPSLATE_SPIRIT_GEN_2 = registerPlacedOreFeature("overworld_deepslate_spirit_vein_2",
				new ConfiguredFeature<>(Feature.ORE, deepslate_spirit_vein_2),
				CountPlacement.of(5),
				InSquarePlacement.spread(),
				BiomeFilter.biome(),
				HeightRangePlacement.triangle(VerticalAnchor.absolute(-44),
	...
	public static void onBiomeLoadingEvent(BiomeLoadingEvent event) {
		if (event.getCategory() == Biome.BiomeCategory.THEEND || event.getCategory() == Biome.BiomeCategory.NETHER);
			...
			event.getGeneration().addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, DEEPSLATE_SPIRIT_GEN_2);
