...
public abstract class ElementalConsumer extends TechniqueAspect {
	 ...
	 * @param proficiency the proficiency of this current aspect
	 */
	public abstract void consumed(HashMap<String, Object> metaData, BigDecimal proficiency);
