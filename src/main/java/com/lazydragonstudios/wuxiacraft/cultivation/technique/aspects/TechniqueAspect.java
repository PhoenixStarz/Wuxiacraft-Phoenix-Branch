...
public abstract class TechniqueAspect {
	...
	public void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.fill(mouseX, mouseY, mouseX + tooTipWidth, mouseY + 13, 0x6A8080A0);
	 ...
	 */
		...
		private final BigDecimal proficiencyRequired;

		private final BigDecimal modifier;

		private final Consumer<ICultivation> onReached;

		private final HashSet<ResourceLocation> skills;

		/**
		 *
		 */
		public Checkpoint(String name, BigDecimal proficiencyRequired, BigDecimal modifier,
		...
		public BigDecimal proficiencyRequired() {
		...
		public Consumer<ICultivation> onReached() {
			return onReached;
		}

		public HashSet<ResourceLocation> skills() {
			return skills;
		}
		...
		public boolean equals(Object obj) {
			...
			var that = (Checkpoint) obj;
			return Objects.equals(this.name, that.name) &&
					Objects.equals(this.proficiencyRequired, that.proficiencyRequired) &&
					Objects.equals(this.modifier, that.modifier) &&
					Objects.equals(this.onReached, that.onReached) &&
					Objects.equals(this.skills, that.skills);
		}

		@Override
		public int hashCode() {
			return Objects.hash(name, proficiencyRequired, modifier, onReached, skills);
		}
