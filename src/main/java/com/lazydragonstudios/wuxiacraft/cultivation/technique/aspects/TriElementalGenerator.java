...
public class TriElementalGenerator extends TechniqueAspect {
	...
	public TriElementalGenerator(double generated1, ResourceLocation element1, double generated2, ResourceLocation element2, double generated3, ResourceLocation element3) {
		super();
	...
	public boolean canConnect(TechniqueAspect aspect) {
		if (aspect instanceof ElementalGenerator gen) {
			return (gen.element.equals(this.element1) || gen.element.equals(this.element2) || gen.element.equals(this.element3));
		}
		if (aspect instanceof DualElementalGenerator gen) {
			return (gen.element1.equals(this.element1) || gen.element1.equals(this.element2) || gen.element1.equals(this.element3)
				 || gen.element2.equals(this.element1) || gen.element2.equals(this.element2) || gen.element2.equals(this.element3));
		}
		if (aspect instanceof TriElementalGenerator gen) {
			return (gen.element1.equals(this.element1) || gen.element1.equals(this.element2) || gen.element1.equals(this.element3)
				 || gen.element2.equals(this.element1) || gen.element2.equals(this.element2) || gen.element2.equals(this.element3)
				 || gen.element3.equals(this.element1) || gen.element3.equals(this.element2) || gen.element3.equals(this.element3));
		}
		if (aspect instanceof QuadElementalGenerator gen) {
			return (gen.element1.equals(this.element1) || gen.element1.equals(this.element2) || gen.element1.equals(this.element3)
				 || gen.element2.equals(this.element1) || gen.element2.equals(this.element2) || gen.element2.equals(this.element3)
				 || gen.element3.equals(this.element1) || gen.element3.equals(this.element2) || gen.element3.equals(this.element3)
				 || gen.element4.equals(this.element1) || gen.element4.equals(this.element2) || gen.element4.equals(this.element3));
		}
		if (aspect instanceof QuinElementalGenerator gen) {
			return (gen.element1.equals(this.element1) || gen.element1.equals(this.element2) || gen.element1.equals(this.element3)
				 ...
				 || gen.element3.equals(this.element1) || gen.element3.equals(this.element2) || gen.element3.equals(this.element3)
				 || gen.element4.equals(this.element1) || gen.element4.equals(this.element2) || gen.element4.equals(this.element3)
				 || gen.element5.equals(this.element1) || gen.element5.equals(this.element2) || gen.element5.equals(this.element3));
		}
		if (aspect instanceof ElementalConsumer con) {
			return (con.element.equals(this.element1) || con.element.equals(this.element2) || con.element.equals(this.element3));
		}
	...
	public void renderTooltip(PoseStack poseStack, int mouseX, int mouseY) {
		...
		var tooTipWidth = Math.max(nameWidth + 10, 90 + amountWidth1 + amountWidth2 + amountWidth3);
