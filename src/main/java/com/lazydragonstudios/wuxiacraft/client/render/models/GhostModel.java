...
public class GhostModel extends EntityModel<AbstractClientPlayer> implements ArmedModel, HeadedModel {
	...
	public void prepareMobModel(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTick) {
		...
		if(player.getMainArm() == HumanoidArm.LEFT) {
			this.leftArmPose = AbstractBodyTransformationArmedModel.getArmPose(player, InteractionHand.MAIN_HAND);
			this.rightArmPose = AbstractBodyTransformationArmedModel.getArmPose(player, InteractionHand.OFF_HAND);
		} else {
			this.rightArmPose = AbstractBodyTransformationArmedModel.getArmPose(player, InteractionHand.MAIN_HAND);
			this.leftArmPose = AbstractBodyTransformationArmedModel.getArmPose(player, InteractionHand.OFF_HAND);
		}
