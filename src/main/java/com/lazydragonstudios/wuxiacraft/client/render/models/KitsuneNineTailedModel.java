...
public class KitsuneNineTailedModel extends AbstractBodyTransformationModel {

	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LOCATION = new ModelLayerLocation(new ResourceLocation(WuxiaCraft.MOD_ID, "kitsune_9_tail"), "main");
	...
	private final ModelPart tail_start_9;

	private final ModelPart tail_middle_9;

	private final ModelPart tail_end_9;

	public KitsuneNineTailedModel(ModelPart root) {
		...
		this.tail_start_9 = this.tail_root.getChild("tail_start_9");
		this.tail_middle_9 = this.tail_start_9.getChild("tail_middle_9");
		this.tail_end_9 = this.tail_middle_9.getChild("tail_end_9");
	}
	...
	public static LayerDefinition createMesh() {
		...
		PartDefinition tail_start_9 = tail_root.addOrReplaceChild("tail_start_9", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition tail_middle_9 = tail_start_9.addOrReplaceChild("tail_middle_9", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 4.0F));

		PartDefinition tail_end_9 = tail_middle_9.addOrReplaceChild("tail_end_9", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 4.0F));

		PartDefinition cube_r9 = tail_end_9.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(4, 10).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(0.0F, 0.0F, 4.5F, 0.0F, 0.7854F, 0.0F));
	...
	public void setupAnim(AbstractClientPlayer pEntity, float limbSwing, float limbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		pAgeInTicks += phaseIncrement;
		tail_start_9.xRot = -0.7854F +0.48f - Mth.abs(Mth.cos(limbSwing * 0.22F)) * 0.7F * limbSwingAmount;
		tail_start_9.yRot = Mth.cos(pAgeInTicks * 0.01F) * 0.3F + Mth.cos(limbSwing * 0.44F)*0.3f*limbSwingAmount;
		tail_middle_9.xRot = 0.15f - Mth.abs(Mth.cos(limbSwing * 0.13F)) * 0.4F * limbSwingAmount;
		tail_middle_9.yRot = Mth.cos(pAgeInTicks * 0.03F) * 0.1F;
		tail_end_9.xRot = -0.15f + Mth.cos(0.75f+limbSwing * 0.44F) * 0.7F * limbSwingAmount;
		tail_end_9.yRot = Mth.cos(1.5f+pAgeInTicks * 0.03F) * 0.1F;
	}
}