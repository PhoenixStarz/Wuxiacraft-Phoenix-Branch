...
public class KitsuneSevenTailedModel extends AbstractBodyTransformationModel {

	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LOCATION = new ModelLayerLocation(new ResourceLocation(WuxiaCraft.MOD_ID, "kitsune_7_tail"), "main");
	...
	public KitsuneSevenTailedModel(ModelPart root) {
	...
	public void setupAnim(AbstractClientPlayer pEntity, float limbSwing, float limbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		tail_start_7.yRot = Mth.cos(pAgeInTicks * 0.03F) * 0.3F + Mth.cos(limbSwing * 0.44F)*0.3f*limbSwingAmount;
