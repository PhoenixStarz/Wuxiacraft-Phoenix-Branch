...
import com.lazydragonstudios.wuxiacraft.client.overlays.CombatModeOverlay;
...
public class ClientSetupEventHandler {
	...
	public static void onClientSetup(FMLClientSetupEvent event) {
		...
		OverlayRegistry.registerOverlayTop("wuxiacraft_combat_mode", new CombatModeOverlay());
