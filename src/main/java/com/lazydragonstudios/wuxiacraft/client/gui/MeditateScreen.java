...
public class MeditateScreen extends Screen {
	...
	private System system = System.DIVINE;
	...
	static {
//BodyMinigame,DivineMinigame,HoldingClickMinigame,DraggingToDanTianMinigame,DraggingThroughPathwaysMinigame,DraggingAllAspectsToDantianMinigame
		stageMiniGames.put(WuxiaRealms.BODY_MORTAL_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_GATHERING_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_PATHWAYS_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_CONDENSATION_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_PHENOMENON_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_SHAPING_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_MOLDING_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_SOLIDIFICATION_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_CORE_SHAPING_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.BODY_GOLDEN_CORE_STAGE.getId(), BodyMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_MORTAL_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_GATHERING_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_PATHWAYS_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_CONDENSATION_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_PHENOMENON_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_SHAPING_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_MOLDING_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_SOLIDIFICATION_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_CORE_SHAPING_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.DIVINE_GOLDEN_CORE_STAGE.getId(), DivineMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_MORTAL_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_GATHERING_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_PATHWAYS_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_CONDENSATION_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_PHENOMENON_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_SHAPING_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_MOLDING_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_QI_SOLIDIFICATION_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_CORE_SHAPING_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_GOLDEN_CORE_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
	}
