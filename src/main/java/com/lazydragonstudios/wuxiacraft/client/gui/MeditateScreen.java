...
public class MeditateScreen extends Screen {
	...
	static {
		...
		stageMiniGames.put(WuxiaRealms.ESSENCE_CORE_EXPANSION_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_REVOLVING_CORE_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_IMMORTAL_TRANSFORMATION_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_IMMORTAL_POND_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_RIVER_EXPANSION_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
		stageMiniGames.put(WuxiaRealms.ESSENCE_BOUNDLESS_SEA_STAGE.getId(), DraggingAllAspectsToDantianMinigame::new);
