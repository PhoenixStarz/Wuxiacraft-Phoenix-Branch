...
public enum PlayerHealthTooltip implements IEntityComponentProvider, IServerDataProvider<EntityAccessor> {
	...
	public void appendServerData(CompoundTag compoundTag, EntityAccessor entityAccessor) {
		...
		var hp = StatsUtil.getShortHealthAmount(cultivation.getStat(PlayerStat.HEALTH));
		var maxHp = StatsUtil.getShortHealthAmount(cultivation.getStat(PlayerStat.MAX_HEALTH));
	...
	public void appendTooltip(ITooltip iTooltip, EntityAccessor entityAccessor, IPluginConfig iPluginConfig) {
		...
		if(!(serverTag.contains("wuxiaHP") && serverTag.contains("wuxiaMaxHP"))) return;
