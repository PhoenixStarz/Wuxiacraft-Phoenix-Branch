...
public enum CelestialArmorMaterial implements ArmorMaterial {
    CELESTIAL_IRON("celestial_iron", 60, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 3);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 5);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 6);
        p_266655_.put(ArmorItem.Type.HELMET, 3);
    }), 9, SoundEvents.ARMOR_EQUIP_IRON, 2.0F, 0.0F, () -> Ingredient.of(WuxiaItems.CELESTIAL_IRON_INGOT.get()));
    ...
    CelestialArmorMaterial(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionTypeMap,
    ...
    public String getName() {
        return WuxiaCraft.MOD_ID + ":" + this.name;
    }
