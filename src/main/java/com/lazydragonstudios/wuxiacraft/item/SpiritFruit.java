...
public class SpiritFruit extends Item {
	...
	public SpiritFruit(Properties properties, int strength) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity livingEntity) {
		stack.shrink(1);
		livingEntity.addEffect(new MobEffectInstance(WuxiaMobEffects.ENLIGHTENMENT.get(), 300 * 20, this.strength, true, true, false));
		return stack;
	}
