...
public class RunemakingTable extends BaseContainerBlockEntity {
	...
	protected Component getDefaultName() {
		return Component.translatable("wuxiacraft.runemaking_table");
	}
	...
	public ItemStack getResultItemStack() {
		...
		Recipe<Container> recipe = this.level.getRecipeManager().getRecipeFor(WuxiaRecipeTypes.RUNEMAKING_RECIPE_TYPE.get(), this, this.level).orElse(null);
		if (recipe == null) return ItemStack.EMPTY;
		return recipe.assemble(this, this.getLevel().registryAccess());
	}
