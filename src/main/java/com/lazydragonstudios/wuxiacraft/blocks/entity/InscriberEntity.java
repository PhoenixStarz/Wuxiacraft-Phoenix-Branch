...
public class InscriberEntity extends BaseContainerBlockEntity {
	...
	protected Component getDefaultName() {
		return Component.translatable("wuxiacraft.inscriber");
	}
	...
	public void createTechnique(String techniqueName, Player player, System system) {
		...
		itemTag.putString("author", player.getDisplayName().getString());
		var cultivation = Cultivation.get(player);
		var systemData = cultivation.getSystemData(system);
		var radius = BigDecimal.ONE.add(cultivation.getStat(system, PlayerSystemStat.ADDITIONAL_GRID_RADIUS));
